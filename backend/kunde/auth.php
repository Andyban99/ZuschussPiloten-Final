...
function saveKundeData($kunde_id, $data) {
    try {
        ...
        $stmt->execute([
            ...
            ':unternehmen_email' => $data['unternehmen_email'] ?? '',
            ':rechtsform' => $data['rechtsform'] ?? '',
            ':gruendungsdatum' => !empty($data['gruendungsdatum']) ? $data['gruendungsdatum'] : null,
            ...
            ':geschaeftsjahre' => $data['geschaeftsjahre'] ?? null,
            ':wirtschaftlich_berechtigte' => $data['wirtschaftlich_berechtigte'] ?? null,
            ':gesellschafter' => $data['gesellschafter'] ?? null,
            ':durchfuehrungsort_gleich_adresse' => $data['durchfuehrungsort_gleich_adresse'] ?? 1,
            ':durchfuehrungsort_strasse' => $data['durchfuehrungsort_strasse'] ?? '',
            ':durchfuehrungsort_hausnummer' => $data['durchfuehrungsort_hausnummer'] ?? '',
            ':durchfuehrungsort_plz' => $data['durchfuehrungsort_plz'] ?? '',
            ':durchfuehrungsort_ort' => $data['durchfuehrungsort_ort'] ?? '',
            ':abschreibungen' => $data['abschreibungen'] ?? null,
            ':arbeitsplaetze_frauen' => $data['arbeitsplaetze_frauen'] !== '' ? $data['arbeitsplaetze_frauen'] : null,
            ':arbeitsplaetze_maenner' => $data['arbeitsplaetze_maenner'] !== '' ? $data['arbeitsplaetze_maenner'] : null,
            ':arbeitsplaetze_ausbildung' => $data['arbeitsplaetze_ausbildung'] !== '' ? $data['arbeitsplaetze_ausbildung'] : null,
            ':arbeitsplaetze_leiharbeiter' => $data['arbeitsplaetze_leiharbeiter'] !== '' ? $data['arbeitsplaetze_leiharbeiter'] : null,
            ':geplante_arbeitsplaetze_frauen' => $data['geplante_arbeitsplaetze_frauen'] !== '' ? $data['geplante_arbeitsplaetze_frauen'] : null,
            ':geplante_arbeitsplaetze_maenner' => $data['geplante_arbeitsplaetze_maenner'] !== '' ? $data['geplante_arbeitsplaetze_maenner'] : null,
            ':geplante_arbeitsplaetze_ausbildung' => $data['geplante_arbeitsplaetze_ausbildung'] !== '' ? $data['geplante_arbeitsplaetze_ausbildung'] : null,
            ':investitionsgueter' => $data['investitionsgueter'] ?? null,
            ':id' => $kunde_id
        ]);
        return true;
    } catch (PDOException $e) {
